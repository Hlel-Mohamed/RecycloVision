...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    if (themeController) {
      setIsDarkMode(themeController.checked)
      themeController.addEventListener("change", (e: any) => {
  ...
  return (
    <nav className={`navbar ${isDarkMode ? "bg-base-100" : "bg-[#dbf4f4]"} border-b-[1px] border-base-300 justify-between !py-0 !h-fit px-20`}>
      <img
        onClick={() => navigate("/")}
        src="RecycloVisionLogo.png"
        alt="navlogo"
