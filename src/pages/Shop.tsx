...
const products = [
  ...
  },
  {
    ...
    description: 'A notebook made from recycled paper, perfect for jotting ideas sustainably.',
    price: 10,
    coins: 20,
...
const Shop = () => {
  ...
  return (
    <div className="px-10 py-5 h-full w-full">
      <h1 className="text-4xl font-bold text-center text-green-700 mb-8">Eco-Friendly Shop</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        >
          ...
          />
          <h5 className="text-lg font-semibold text-center text-gray-800">{product.name}</h5>
          <p className="text-gray-600 text-center text-sm flex-grow">{product.description}</p>
          <div className="mt-auto text-center w-full">
            <p className="text-green-700 font-medium mt-2">Price: ${product.price}</p>
            <p className="text-green-700 font-medium">Coins: {product.coins}</p>
            <button
