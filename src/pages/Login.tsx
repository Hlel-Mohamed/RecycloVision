    ...
    <div className="hero bg-base-200 min-h-screen">
      <div className="hero-content flex-col lg:flex-row-reverse">
        <div className="flex flex-col items-center text-center w-full lg:w-1/2">
          <img
            src="RecycloVisionWithTitle.png"
            alt="logo"
            className="h-72 w-85"
          />
          <p className="py-6 text-2xl">
            From collecting recyclables to earning eco-friendly rewards, manage
            all your recycling activities with ease. Track your progress, redeem
            rewards, and make a positive impact
          </p>
        </div>
